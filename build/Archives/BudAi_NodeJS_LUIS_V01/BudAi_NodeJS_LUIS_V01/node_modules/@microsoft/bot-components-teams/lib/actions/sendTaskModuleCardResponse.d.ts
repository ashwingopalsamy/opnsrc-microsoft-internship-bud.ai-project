 ...
 */
export declare class SendTaskModuleCardResponse extends BaseSendTaskModuleContinueResponse implements SendTaskModuleCardResponseConfiguration {
    /**
     * Class identifier.
     */
    static $kind: string;
     ...
     */
    card?: TemplateInterface<Activity, DialogStateManager>;
    getConverter(property: keyof SendTaskModuleCardResponseConfiguration): Converter | ConverterFactory;
    /**
