...
exports.GetTeamChannels = void 0;
 ...
 */
class GetTeamChannels extends botbuilder_dialogs_1.Dialog {
    constructor() {
        super(...arguments);
        /**
    ...
    beginDialog(dc, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield botbuilder_1.TeamsInfo.getTeamChannels(dc.context, teamId);
    ...
    onComputeId() {
        ...
        return `GetTeamChannels[\
            ...
            ${(_d = (_c = this.property) === null || _c === void 0 ? void 0 : _c.toString()) !== null && _d !== void 0 ? _d : ''}\
        ]`;
    }
}
 ...
 * Class identifier.
 */
GetTeamChannels.$kind = 'Teams.GetTeamChannels';
//# sourceMappingURL=getTeamChannels.js.map