 ...
 */
export declare class SendMEBotMessagePreviewResponse extends BaseSendTaskModuleContinueResponse implements SendMEBotMessagePreviewResponseConfiguration {
    /**
     * Class identifier.
     */
    static $kind: string;
     ...
     */
    card?: TemplateInterface<Activity, DialogStateManager>;
    getConverter(property: keyof SendMEBotMessagePreviewResponseConfiguration): Converter | ConverterFactory;
    /**
