 ...
 */
export declare class SendTaskModuleMessageResponse extends BaseTeamsCacheInfoResponseDialog implements SendTaskModuleMessageResponseConfiguration {
    /**
     * Class identifier.
     */
    static $kind: string;
    ...
    getConverter(property: keyof SendTaskModuleMessageResponseConfiguration): Converter | ConverterFactory;
    /**
