 ...
 */
export declare class SendAppBasedLinkQueryResponse extends BaseTeamsCacheInfoResponseDialog implements SendAppBasedLinkQueryResponseConfiguration {
    /**
     * Class identifier.
     */
    static $kind: string;
     ...
     */
    card?: TemplateInterface<Activity, DialogStateManager>;
    getConverter(property: keyof SendAppBasedLinkQueryResponseConfiguration): Converter | ConverterFactory;
    /**
