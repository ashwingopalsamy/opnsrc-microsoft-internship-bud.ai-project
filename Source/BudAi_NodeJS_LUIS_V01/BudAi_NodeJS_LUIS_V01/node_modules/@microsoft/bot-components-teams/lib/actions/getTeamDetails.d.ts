 ...
 */
export declare class GetTeamDetails extends Dialog implements GetTeamDetailsConfiguration {
    /**
     * Class identifier.
     */
    static $kind: string;
    ...
    getConverter(property: keyof GetTeamDetailsConfiguration): Converter | ConverterFactory;
    /**
