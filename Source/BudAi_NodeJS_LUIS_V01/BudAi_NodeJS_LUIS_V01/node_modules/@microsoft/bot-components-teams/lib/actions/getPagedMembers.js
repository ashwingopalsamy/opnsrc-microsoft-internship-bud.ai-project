...
exports.GetPagedMembers = void 0;
 ...
 */
class GetPagedMembers extends botbuilder_dialogs_1.Dialog {
    ...
    beginDialog(dc, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield botbuilder_1.TeamsInfo.getPagedMembers(dc.context, pageSize, continuationToken);
    ...
    onComputeId() {
        ...
        return `GetPagedMembers[\
            ${(_b = (_a = this.continuationToken) === null || _a === void 0 ? void 0 : _a.toString()) !== null && _b !== void 0 ? _b : ''},\
            ${(_d = (_c = this.pageSize) === null || _c === void 0 ? void 0 : _c.toString()) !== null && _d !== void 0 ? _d : ''},\
            ${(_f = (_e = this.property) === null || _e === void 0 ? void 0 : _e.toString()) !== null && _f !== void 0 ? _f : ''}\
        ]`;
    }
}
exports.GetPagedMembers = GetPagedMembers;
/**
 * Class identifier.
 */
GetPagedMembers.$kind = 'Teams.GetPagedMembers';
//# sourceMappingURL=getPagedMembers.js.map